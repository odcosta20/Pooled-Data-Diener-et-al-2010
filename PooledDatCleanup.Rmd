...
---
**README**
Below is the script for the Diener et al. (2010) data paper. We recommend to download the "Diener_et_al_replication_data.csv" from the OSF or GitHub pages and run the script to access the cleaned dataset. However, the clean dataset is provided in the OSF and GitHub pages titled "cleaned_diener_et_al_dataset.csv". 
